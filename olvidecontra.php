...
<header class="row header--sticky">
    ...
    <section class="row">
        ...
        <form action="servicios/olvidcontra.php" method="POST" class="form_login">
				<h3>Olvide mi contraseña</h3>
               
				<input type="text" name="emausu" placeholder="Ingrese su Correo">

                <input type="password" name="pasusu1" placeholder="Nueva Contraseña">
				<?php
					if (isset($_GET['e'])) {
						switch ($_GET['e']) {
							case '1':
								echo '<p>Email no existe</p>';
							break;	
						}
					}
				?>
